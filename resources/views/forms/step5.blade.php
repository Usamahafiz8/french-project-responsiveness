        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="centimeter" name="s5_wall_thickness">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="In centimeter" name="s5_thickness">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
    ...
    <div class="col-lg-9">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <input class="form-control" type="text" name="s5_area2">
            </div><!--col-lg-3 end--->

            <div class="col-lg-3">
                <label for="s5_area3">Surface 3</label>
                <input class="form-control" type="text" name="s5_area3">
            </div><!--col-lg-3 end--->
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <input class="form-control" type="text" name="s5_t_srfc_area" placeholder="meter square">
            </div><!--col-lg-4 end--->
            <div class="col-lg-4">
